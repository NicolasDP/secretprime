...
instance ToSample (Entity User) where
  toSamples _ = samples []
instance ToSample UserPassword where
  toSamples _ = samples []
instance ToSample (Entity UserPassword) where
  toSamples _ = samples []
instance ToSample UserIdentification where
  toSamples _ = samples []
instance ToSample (Entity UserIdentification) where
  toSamples _ = samples []
instance ToSample UserPasswordShares where
  toSamples _ = samples []
instance ToSample (Entity UserPasswordShares) where
  toSamples _ = samples []
